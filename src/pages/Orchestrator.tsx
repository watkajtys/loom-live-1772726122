    ...
    >
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 flex gap-2 overflow-hidden relative">
          ...
          <section className="flex-1 border border-accent/30 shadow-[0_0_10px_rgba(0,242,255,0.1)] bg-black/40 flex flex-col overflow-hidden relative z-10">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-3">
              {logs.map((log) => (
                <div key={log.id} className={`border border-accent/10 bg-black/40 p-3 mb-2 hover:border-accent/30 transition-all duration-200 relative overflow-hidden ${log.color === 'red-500' ? 'border-red-500/20' : ''}`}>
                  ...
                  {log.id === 1 && (
                    <div className="mt-2 flex gap-1 telemetry-banner">
