...
export default function Home() {
  return (
    <div className="flex-1 grid grid-cols-12 grid-rows-6 gap-4 overflow-hidden h-full">
      ...
      <section className="col-span-12 lg:col-span-4 row-span-1 glass-panel rounded-lg p-4 flex gap-4">
        <div className="flex-1 flex flex-col justify-center border-r border-primary/10">
          ...
          <div className="text-xl font-bold font-mono">
            98<span className="text-xs text-slate-500 ml-1">ms</span>
          </div>
        </div>
        <div className="flex-1 flex flex-col justify-center border-r border-primary/10">
          <div className="flex items-center gap-2 mb-1">
            <span className="material-symbols-outlined text-accent text-sm">code</span>
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="flex items-center gap-2 mb-1">
            <span className="material-symbols-outlined text-accent text-sm">alternate_email</span>
            <span className="text-[10px] font-mono uppercase text-slate-400">X / Twitter</span>
          </div>
          <div className="text-xl font-bold font-mono">
            1.2k<span className="text-xs text-slate-500 ml-1">rq/m</span>
          </div>
        </div>
      </section>
        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-2xl font-bold font-mono">
              142.8 <span className="text-sm font-normal text-slate-400">ops/m</span>
            </p>
          </div>
          <div className="flex gap-2">
            <span className="px-2 py-1 text-[10px] bg-accent/10 text-accent border border-accent/20 rounded font-mono">
              LIVE_STREAM
            </span>
          </div>
        </div>
      ...
      <section className="col-span-12 lg:col-span-9 row-span-4 glass-panel rounded-lg flex flex-col overflow-hidden border-t-2 border-t-accent/30">
        ...
        <div className="flex-1 p-4 font-mono text-sm terminal-scroll overflow-y-auto bg-black/40">
          <div className="mb-2">
            <span className="text-accent">[14:22:01]</span> <span className="text-green-400">INGEST_SUCCESS:</span> Github
            Webhook - Repository: 'advoloom-core' - Pull Request #421
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:05]</span> <span className="text-primary">AGENT_REPLY:</span>{' '}
            Llama-3-70B processing technical query on Discord #general...
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:10]</span> <span className="text-slate-400">NEURAL_MAP:</span> Updating
            context vector for 'Authentication Flow' tutorials
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:15]</span> <span className="text-yellow-400">WARN:</span> Rate limit
            approaching for X-API v2 [88% capacity]
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:18]</span> <span className="text-green-400">INGEST_SUCCESS:</span> New
            tutorial request identified from Discord thread ID 99283
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:20]</span> <span className="text-primary">AGENT_OUTPUT:</span> "To
            initialize the SDK, use the `adv.init()` method with your API key..."
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:25]</span> <span className="text-green-400">INGEST_SUCCESS:</span> 4
            files synced from 'documentation-v2' main branch
          </div>
          <div className="mb-2">
            <span className="text-accent">[14:22:31]</span> <span className="text-slate-400">SYSTEM:</span> Garbage
            collection complete. 1.2MB memory reclaimed.
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="flex-1 overflow-y-auto p-2 space-y-2">
          <div className="p-3 bg-primary/10 rounded-lg border border-primary/20 hover:border-accent/40 transition-colors group cursor-pointer">
            ...
            <div className="mt-2 flex gap-1">
              <span className="px-1 text-[8px] border border-primary/30 text-primary-300 rounded uppercase">
                Tutorial_Update
              </span>
            </div>
          </div>
