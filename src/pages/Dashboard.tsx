            ...
            <div className="w-full max-w-2xl px-4 pointer-events-auto">
              <div className="bg-black/90 border border-white/20 shadow-2xl backdrop-blur-2xl p-3 flex items-center gap-4 group">
                ...
                <div className="flex-1 flex items-center">
                  ...
                  <input autoFocus className="bg-transparent border-none focus:ring-0 text-white font-mono text-sm w-full uppercase placeholder-placeholder outline-none" placeholder="EXECUTE_MACRO_OR_SYSTEM_COMMAND..." type="text"/>
